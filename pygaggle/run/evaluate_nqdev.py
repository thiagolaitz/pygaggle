...
class NQEvaluationOptions(BaseModel):
    dataset: Path
    method: str
    batch_size: int
    device: str
...
def construct_t5(options: NQEvaluationOptions) -> Reranker:
...
def construct_duot5(options: NQEvaluationOptions) -> Reranker:
...
def construct_mt5(options: NQEvaluationOptions) -> Reranker:
...
def construct_transformer(options: NQEvaluationOptions) -> Reranker:
...
def construct_qa_transformer(options: NQEvaluationOptions) -> Reranker:
...
def construct_mt5_en_pt(options: NQEvaluationOptions) -> Reranker:
...
def construct_minilm(options: NQEvaluationOptions) -> Reranker:
    if options.model:
...
def construct_biencoder(options: NQEvaluationOptions) -> Reranker:
    if options.model:
